...
<head>
	...
	<link rel="stylesheet" href="<ion:theme_url />assets/css/bootstrap-theme.min.css">
	<link rel="stylesheet" href="<ion:theme_url />assets/css/flat-ui.min.css">
	...
	<link href='https://docs.google.com/static/forms/client/css/2588955203-mobile_formview_st_ltr.css' type='text/css' rel='stylesheet' media='screen and (max-device-width: 721px)'>
	<style>
		html {
		  position: relative;
		  min-height: 100%;
...
<ion:user:logged is="true">
	<div class="contain-to-grid fixed">
			<nav data-topbar="" class="topbar" role="navigation">
					<div class="search-bar"><ion:search:form /></div>
	...
	<!-- container -->
	<div class="container" style="margin-bottom:60px;margin-top:94px;">